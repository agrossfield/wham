...
This code is available for download from Github
(\url{https://github.com/agrossfield/wham/}). The code doesn't
...
method'', \url{https://github.com/agrossfield/wham}, version XXXX
...
\subsection{New in release 2.1.1}
Added support for the "kj" energy unit, which is kJ/mol-Kelvin.  This is the
default energy unit used in LAMMPS, so this should make it easier to use wham
with LAMMPS output.  Requested by Agilio Padua.
